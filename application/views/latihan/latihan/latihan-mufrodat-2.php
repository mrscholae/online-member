<div class="container">
            <div class="row">
                <div class="col-12 col-md-12 mb-3">
                    <a id="backHome" class="btn btn-md btn-danger text-light"><i class="fa fa-times"></i> keluar</a>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <select name="font" id="fontSize" class="form-control form-control-sm">
                ...
                <div class="col-12 mb-1">
                    <div class="alert alert-warning"><i class="fa fa-exclamation-circle text-warning mr-1"></i>Susunlah huruf-huruf untuk membentuk fiil madhi dari setiap dhomir</div>
                </div>
            </div>
            <div class="row">
            ...
            <form action="" id="formSoal">
                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="select<?=$i?>">
                                            ...
                                            <div class="d-flex justify-content-center mt-2">
                                                <a class="btn btn-md btn-danger img-shadow text-light mr-3 hapus" data-id="<?= $i?>"><i class="fa fa-backspace"></i></a>
                                                <!-- <a class="btn btn-md btn-info img-shadow text-light mr-3 cek" data-id="<?= $i?>|1">input</a> -->
                                            </div>
                                        </div>
                                    </div>
                                    <?php if($i == 0) :?>
                                        <div class="d-flex justify-content-center">
                                            <a id="right<?= $i?>" data-id="<?= $i?>" class="img-shadow btn btn-md btn-success text-light right mr-3"><i class="fa fa-angle-right"></i></a>
                                        </div>
                    ...
                    <div class="col-12 col-md-12 mb-3 text-center angka">
                        <span class="btn btn-md btn-secondary"><span id="angka">1</span> / <?= COUNT($mufrodat)?></span>
                    </div>
                </div>
            </form>
            <div class="row">
...
<script>
    ...
    $("#backHome").click(function(){
        Swal.fire({
            ...
            confirmButtonText: '<a href="<?= base_url("latihan")?>">Ya</a>',
